<script>
  ...
  // ═══════════════════════════════════════════════════════
  // BLOCKS → JSON Konvertierung für Speichern + Laden
  // ═══════════════════════════════════════════════════════
...
<style>
  ...
  .modal-box { background:var(--surface); border-radius:14px; padding:28px; box-shadow:0 20px 60px rgba(0,0,0,0.3); width:100%; }
