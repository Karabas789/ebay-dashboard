...
<style>
  ...
  .sidebar.collapsed .sidebar-logo { flex-direction:column; align-items:center; padding:12px 8px 10px; gap:6px; }
  .sidebar.collapsed .toggle-btn { position:static; margin:0; }
